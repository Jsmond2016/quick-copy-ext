...
| 功能 | 说明 | 适用模式 |
|------|------|---------|
| [接口请求捕获](/features/request-capture) | 自动监听页面 XHR/fetch 请求 | 所有模式 |
| [Apifox 接口关联](/features/apifox-integration) | 对接 Apifox 文档，关联接口名称和链接 | 所有模式 |
| [响应异常规则](/features/response-error-rules) | 自定义业务异常判断规则 | 所有模式 |
...
|------|------|---------|
| 默认模式 | 基础复制功能 | 基础复制 |
| 开发者模式 | 增加 Quick Mock 支持 | 显示"快速 Mock"按钮 |
| 测试者模式 | 增加 AIO 批量复制 | 显示"复制到 AIO"按钮，含迭代选择器 |
